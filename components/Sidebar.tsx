...
import { LayoutDashboard, MessageSquare, KanbanSquare, Users, LogOut, Shield, BarChart3, Zap, Briefcase, Target, ActivitySquare } from 'lucide-react';
      ...
      <div className="flex-1 w-full space-y-3">
        {!isSuperAdmin && (
          <>
            ...
            <NavItem view={ViewState.BLACK_BI} icon={ActivitySquare} label="Black BI" />
            <NavItem view={ViewState.LEADS} icon={Target} label="Leads" />
