...
serve(async (req) => {
    ...
    try {
        ...
        // Sempre use o Client Admin para criar a organização no banco (RLS BYPASS)
        ...
        // Client com Autenticação do Usuário (se houver) para actions que precisam do Contexto dele
